...
if (!isset($_SESSION['loggedInSkeleton']))
{
    ...
    if ($errors == "")
    {
        ...
        {
            // we need an UPDATE:
            $query = "UPDATE users SET username= '$username', password= '$password', firstname='$firstName', surname='$surname', email= '$email' , DOB= '$DOB' , telephone= '$telephoneNumber'
...
echo <<<_END
    ...
    <tr>
    <td>First name: </td><td><input type="text" name="firstname" maxlength="32" value= "$firstName" </td>
    </tr>
    <tr>
    ...
    <tr>
    <td >telephoneNumber: </td><td><input type="text" name="telephone" maxlength="15" value= "$telephoneNumber"</td>
    </tr>
