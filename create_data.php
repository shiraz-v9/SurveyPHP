...
for ($i=0; $i<count($usernames); $i++)
{
    ...
    $sql = "INSERT INTO users (username, password, firstname, surname, email, DOB, telephone) 
    VALUES ('$usernames[$i]', '$passwords[$i]', '$firstnames[$i],'$surnames[$i]', '$emails[$i]', '$DOBs[$i]', '$telephones[$i]')";
